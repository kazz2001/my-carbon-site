...
![Brockhampton / Roadrunner: New Light, New Machine](../../images/cd/brockhampton2L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3nU4tH1" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/2ZfVENr" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
		<Button className="button-right-mergin"  href="https://geo.music.apple.com/us/album/roadrunner-new-light-new-machine-plus-pack/1569675412?itsct=music_box_link&itscg=30200&at=11lcug&ls=1&app=music" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      ampple music
    </Button>
		<AdvJS2/>
	</div>
