...
![Alicia Keys / KEYS](../../images/cd/aliciakeys8L.jpg)
  ...
  <div>
	  <Button className="button-right-mergin" href="https://amzn.to/3w3N8Ol" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin" href="https://amzn.to/3LPSkMD" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
    <Button className="button-right-mergin" href="https://apple.co/3kJVwNH" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
    <AdvJS2/>
	</div>
