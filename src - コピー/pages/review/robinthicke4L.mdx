...
![Robin Thicke / On Earth, And In Heaven](../../images/cd/robinthicke4L.jpg)
  ...
  <div>
	  <Button className="button-right-mergin" href="https://amzn.to/3mZyToK" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin" href="https://amzn.to/2OZvWIi" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
    <Button className="button-right-mergin" href="https://apple.co/3mXCFPJ" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
	</div>
	</Column>
