...
![Mustafa / When Smoke Rises](../../images/cd/mustafa1L.jpg)
  ...
  <div>
	  <Button className="button-right-mergin" href="https://amzn.to/3nd9VmP" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin" href="https://amzn.to/3u01HCh" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
    <Button className="button-right-mergin" href="https://apple.co/3u1Auzn" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
    <AdvJS2/>
	</div>
