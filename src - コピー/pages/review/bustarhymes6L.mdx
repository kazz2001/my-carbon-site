...
![Busta Rhymes / Extinction Level Event 2: The Wrath Of God](../../images/cd/bustarhymes6L.jpg)
    ...
    <Button className="button-right-mergin"  href="https://amzn.to/3p1GGDx" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
		...
		<Button className="button-right-mergin"  href="https://geo.music.apple.com/us/album/extinction-level-event-2-the-wrath-of-god/1534955238?itsct=music_box_link&itscg=30200&at=11lcug&ct=albums_extinction_level_event_2%3A_the_wra&ls=1&app=music" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
	</div>
	</Column>
