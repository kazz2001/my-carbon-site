...
![Jazmine Sullivan / Heaux Tales](../../images/cd/jazminesullivan4L.jpg)
  ...
  <div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3kS7qnT" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3v2oT1A" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
    <Button className="button-right-mergin"  href="https://apple.co/38fRSFB" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
	</div>
  </Column>
