...
![Wale / Shine](../../images/cd/wale4L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/2XmyAJj" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
		<Button className="button-right-mergin"  href="https://amzn.to/2XmbN05" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
	</div>
