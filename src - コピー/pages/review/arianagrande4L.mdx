...
![Ariana Grande / Sweetener](../../images/cd/arianagrande4L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/2YDjSxj" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
      </Button>
      <Button className="button-right-mergin"  href="https://amzn.to/30OsAvs" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
      </Button>
	</div>
