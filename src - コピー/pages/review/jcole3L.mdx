...
![J. Cole / KOD](../../images/cd/jcole3L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3dHN8bQ" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3i98KBc" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
		  amazon.co.jp
    </Button>
	</div>
