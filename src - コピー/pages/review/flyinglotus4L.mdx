...
![Flying Lotus / Yasuke](../../images/cd/flyinglotus4L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		...
		<div>
	  	<Button className="button-right-mergin"  href="https://amzn.to/3qdo9qA" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      	amazon.com
    	</Button>
    	<Button className="button-right-mergin"  href="https://amzn.to/3qdo9qA" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      	amazon.co.jp
    	</Button>
			<Button className="button-right-mergin"  href="https://apple.co/3qg94EU" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      	apple music
    	</Button>
			<AdvJS2/>
		</div>
