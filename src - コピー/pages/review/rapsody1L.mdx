...
![Rapsody / Laila's Wisdom](../../images/cd/rapsody1L.jpg)
	...
	<div>
	    <Button className="button-right-mergin"  href="https://amzn.to/2WDBDMz" renderIcon={ArrowUpRight} size='sm' kind='primary'>
        amazon.com
      </Button>
      <Button className="button-right-mergin"  href="https://amzn.to/2WKjm0q" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
        amazon.co.jp
      </Button>
	</div>
