...
![St. Vincent / Daddy's Home](../../images/cd/stvincent1L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3vc444A" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3ABL7Jz" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
		<Button className="button-right-mergin"  href="https://apple.co/3Dzub8w" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
		<AdvJS2/>
	</div>
