...
![Young THug / Jeffery](../../images/cd/youngthug2L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/31V9HFV" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
	  <Button className="button-right-mergin"  href="https://amzn.to/2PTSCXx" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
	</div>
