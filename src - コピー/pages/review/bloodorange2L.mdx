...
![Blood Orange / Freetown Sound](../../images/cd/bloodorange2L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/337m82a" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/328ZSWf" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
	</div>
