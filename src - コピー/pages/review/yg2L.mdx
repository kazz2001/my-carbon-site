...
![YG / Still Brazy](../../images/cd/yg2L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/2PQQ38l" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
	  <Button className="button-right-mergin"  href="https://amzn.to/2Y0vSJQ" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
	</div>
