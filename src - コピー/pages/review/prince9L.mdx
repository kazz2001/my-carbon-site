...
![Prince / HitnRun phase two](../../images/cd/prince9L.jpg)
    ...
    <div>
	    <Button className="button-right-mergin"  href="https://amzn.to/38nD7l9" renderIcon={ArrowUpRight} size='sm' kind='primary'>
        amazon.com
      </Button>
      <Button className="button-right-mergin"  href="https://amzn.to/386XOS9" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
        amazon.co.jp
      </Button>
      <Button className="button-right-mergin"  href="https://apple.co/3mM6u4c" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
        amazon.co.jp
      </Button>
	  </div>
	</Column>
