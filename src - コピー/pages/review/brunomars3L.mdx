...
![Bruno Mars / 24K Magic](../../images/cd/brunomars3L.jpg)
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		...
		<div>
		  <Button href="https://amzn.to/3gVwKGU" renderIcon={ArrowUpRight} size='sm' kind='primary'>
  	    amazon.com
  	  </Button>
  	  <Button href="https://amzn.to/3h8Mg28" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
  	    amazon.co.jp
  	  </Button>
		</div>
