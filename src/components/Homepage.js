...
const FirstRightText = () => (
   <p className="smallP">
      ...
      <div style={{marginTop: '0.5rem',}}>
        <Button className="button-right-mergin" href="/cd/2026/" renderIcon={ArrowUpRight} size='sm' kind='primary'>
          2026
        </Button>
        <Button className="button-right-mergin" href="/cd/2025/" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
          2025
        </Button>
        <Button className="button-right-mergin" href="/cd/2024/" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
          2024
        </Button>
      ...
      <div style={{marginTop: '0.5rem',}}>
        <Button className="button-right-mergin" href="/best50/2025/" renderIcon={ArrowUpRight} size='sm' kind='primary'>
          2025
        </Button>
        <Button className="button-right-mergin" href="/best50/2024/" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
          2024
        </Button>
        <Button className="button-right-mergin" href="/best50/2023/" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
          2023
        </Button>
