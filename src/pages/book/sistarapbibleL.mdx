...
<Column colMd={4} colLg={8} noGutterMdLeft="">
  <div>
    <p>著者</p>
    <p className="largeP">Clover Hope</p>
    <br/>
    <p>訳者</p>
    ...
    <br/>
    <p>ページ数 / サイズ</p>
    <p className="largeP">238ページ / 19 x 1.8 x 22.6 cm</p>
    <br/>
    <p>発売日</p>
    <p className="largeP">2022/2/28</p>
    <br/>
    <p>定価</p>
    <p className="largeP">2990円(税抜き)</p>
    <div>
    <Button href="https://amzn.to/3PmCStm" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.co.jp
    </Button>
    </div>
  </div>
...
<Row>
  <Column colMd={8} colLg={8} noGutterMdLeft="">
     <p class="p600J">- さあ、男たちに見せつけてやろう 熱いパーティ・ショウでナンバーワンになる方法 -</p>
    <p>
      <br />
