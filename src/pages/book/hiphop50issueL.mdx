...
<Column colMd={4} colLg={8} noGutterMdLeft="">
  <div>
    <p>監修</p>
    <p className="largeP">小渕晃</p>
    <p>編集</p>
    <p className="largeP">野田努</p>
    <br/>
    <p>出版社</p>
    <p className="largeP">(株)Pヴァイン</p>
    <br/>
    <p>ページ数 / サイズ</p>
    <p className="largeP">157ページ / 14.8 x 1.1 x 22 cm</p>
    <br/>
    <p>発売日</p>
    <p className="largeP">2023/12/4</p>
    <br/>
    <p>定価</p>
...
<Row>
  <Column colMd={8} colLg={8} noGutterMdLeft="">
    <p class="p600J">- 100枚の名盤ガイド ライターの偏愛盤を紹介 -</p>
    <p>
      <br />
