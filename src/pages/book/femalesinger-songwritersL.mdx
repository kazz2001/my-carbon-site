...
<Column colMd={5} colLg={8} noGutterMdLeft="">
  <div>
    <p>監修</p>
    <p className="largeP">渡辺亨</p>
    <br/>
    <p>出版社</p>
    <p className="largeP">株式会社ミュージック・マガジン</p>
    <br/>
    <p>ページ数 / サイズ</p>
    <p className="largeP">255ページ / 21 x 14.8 x 2.5 cm</p>
    <br/>
    <p>発売日</p>
    <p className="largeP">2021/5/1</p>
    <br/>
    <p>定価</p>
...
<Row>
  <Column colMd={8} colLg={12} noGutterMdLeft="">
    <p class="p600J">- ローラ・ニーロ、ジョニ・ミッチェルから フィオナ・アップル、エスペランサ、ビリー・アイリッシュまで -</p>
    <p>
      <br />
