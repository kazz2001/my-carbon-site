...
<Column colMd={5} colLg={8} noGutterMdLeft="">
  <div>
    ...
    <br/>
    <p>ページ数 / サイズ</p>
    <p className="largeP">159ページ / 13 x 1.2 x 18.3 cm</p>
    <br/>
    <p>発売日</p>
    <p className="largeP">2016/8/1</p>
    <br/>
    <p>定価</p>
    <p className="largeP">1600円(税抜き)</p>
    <div>
    <Button href="https://amzn.to/3phj1jF" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.co.jp
    </Button>
    </div>
  </div>
...
<Row>
  <Column colMd={8} colLg={12} noGutterMdLeft="">
    <p class="p600J">- 最強のR&Bジャーナリストコンビが現行R&Bの文脈で語るキング・オブ・ポップの音盤レビューと、マイケルが好きならこれも聞け！な進化系R&Bを200枚強選盤。 -</p>
    <p>
      <br />
