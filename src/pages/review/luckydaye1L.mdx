...
![Lucky Daye / Candydrip](../../images/cd/luckydaye1L.jpg)
	...
	<Column colMd={"4"} colLg={"8"} noGutterMdLeft="">
		...
		<div>
		  <Button className="button-right-mergin"  href="https://amzn.to/3Aey5om" kind="primary" size="small" renderIcon={ArrowUpRight24}>
  	    amazon.com
  	  </Button>
  	  <Button className="button-right-mergin"  href="https://amzn.to/3Qfibjl" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
  	    amazon.co.jp
  	  </Button>
			<Button className="button-right-mergin"  href="https://apple.co/3QE7Eh5" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
  	   	apple music
  	  </Button>
			<AdvJS2/>
		</div>
