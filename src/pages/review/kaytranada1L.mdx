...
import Review1_1 from "../review/kaytranada2.mdx";
...
![Kaytranada / 99.9%](../../images/cd/kaytranada1L.jpg)
    ...
    <Column colMd={4} colLg={8} noGutterMdLeft="">
    	...
    	<div>
    		...
    		<Button className="button-right-mergin" href="https://apple.co/3UYk6fu" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
    			apple music
    		</Button>
    		<AdvJS2/>
    	</div>
...
| 13  | Lite Spots             | Louis Kevin Celestin / Jards Macalé / Waly Salomão                                                                                                            | Kaytranada                                    | 03:50 |
| 14  | Leave Me Alone         | Louis Kevin Celestin / Shay Lia                                                                                                                               | Kaytranada feat. Shay Lia                     | 04:37 |
| 15  | Bullets                | Erik Boon / Louis Kevin Celestin / Chester Hansen / Yukimi Nagano / Alexander Sowinski / Matthew Tavares / Fredrik Wallin / Leland Whitty / Håkan Wirenstrand | Kaytranada feat. Little Dragon                | 04:58 |
