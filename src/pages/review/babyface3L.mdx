...
![Babyface / Girls Night Out](../../images/cd/babyface3L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<p>
			Babyfaceの7年ぶりのアルバム。女子仲間が夜、お出かけすることをタイトルにしているように、全曲、女性Guestをメインボーカルに据えて、自身はフォローに回るような構成になっている。
			...
			<br/>それにしても、リリース時で64歳となるBabyfaceの声はいつまでも若々しく、枯れた感じは一切しない。
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Babyface, Khris Riddick-Tynes, Liljumadedabeat and Ali Roots A16(10)
				<br/>Babyface, Kyu Steed and KZ(11)
				<br/>Babyface and Brandon "B.A.M." Hodge(12)
			</p>
			<h3>Guests</h3>
			<p>
				Lala Anthony, Angie Martinez, Ari Lennox, Kehlani, Ella Mai, Queen Naija, Coco Jones, Tiana Major9, Tink, Baby Tate, Muni Long, Amaarae, Tkay Maidza, Sevyn Streeter, Doechii
			</p>
		</div>
	</Column>
</Row>
