...
![Leikeli47 / Shape Up](../../images/cd/leikeli471L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<p>
			...
			<br/>サウンドは結構ユニークで、音数の少なくベースの効いた、パーカッシブでトライバルなTrackに唄うようなRap、あるいは、Rapのような唄の組み合わせがベースとなっている。
			<br/>⑫のような、しっとりとしたバラードや⑥⑦のようなメローな曲もアクセントになっている。多彩なところは判ったので、次の展開も期待したい。
		</p>
		<div>
			<Button className="button-right-mergin" href="https://amzn.to/3SIoAov" renderIcon={ArrowUpRight} size='sm' kind='primary'>
				amazon.com
			</Button>
			<Button className="button-right-mergin" href="https://amzn.to/3bHaUK8" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
				amazon.co.jp
			</Button>
			<Button className="button-right-mergin" href="https://apple.co/3QrvcWC" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
				apple music
			</Button>
			<AdvJS2/>
		</div>
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Clyde Elison, Harry Mejias(14)
			</p>
			<h3>Guests</h3>
			<p>
				Miss J Alexander
...
| 3   | New Money       | Aaron Renner, Hasben Jones, Jabber Stevens                                                                                       | Leikeli47                        | 03:08 |
