...
![John Legend / Darkness And Light](../../images/cd/johnlegend5L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		...
		<div>
		  <Button className="button-right-mergin"  href="https://amzn.to/319qhSc" renderIcon={ArrowUpRight} size='sm' kind='primary'>
		    amazon.com
		  </Button>
		  <Button className="button-right-mergin"  href="https://amzn.to/3gljX06" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
		    amazon.co.jp
		  </Button>
		  <Button className="button-right-mergin"  href="https://apple.co/3wPaH1N" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
		    apple music
		  </Button>
		<AdvJS2/>
		</div>
...
<h3>Producers</h3>
<p>
	Blake Mills(1,2,3,4,6,7,8,9,10,11,12)
	<br/>Blake Mills and John Ryan(5)
</p>
<h3>Guests</h3>
<p>
...
| 2   | Penthouse Floor         | Chancellor Bennet / Greg Kurstin / Blake Mills / John Stephens                                | John Legend feat. Chance The Rapper | 04:43 |
...
| 7   | Surefire                | Ludwig Göransson / Julia Michaels / Blake Mills / Will Oldham / John Stephens                 | John Legend                         | 04:03 |
