...
<p className="largeP">
  <Link to="/best50/2022/">2022 Black Music Best No.50</Link>
</p>
...
![Tank and The Bangas / Red Balloon](../../images/cd/tankandthebangas1L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<p>
  		...
  		<div>
			<Button className="button-right-mergin"  href="https://amzn.to/3gvbvk0" renderIcon={ArrowUpRight} size='sm' kind='primary'>
  	  	amazon.com
  		</Button>
  		<Button className="button-right-mergin"  href="https://amzn.to/3TKIY8g" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
  	  	amazon.co.jp
  		</Button>
			<Button className="button-right-mergin"  href="https://apple.co/3Dl8r2O" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
  	  		amazon.co.jp
  		</Button>
			<AdvJS2/>
		</div>
