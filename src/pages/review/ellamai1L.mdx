...
![Ella Mai / Ella Mai](../../images/cd/ellamai1L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		...
		<div>
			...
			<Button className="button-right-mergin" href="https://apple.co/4bTvYGq" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
				apple music
			</Button>
			<AdvJS2/>
		</div>
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Mustard(4,5,7,8,11,12,13,14)
...
| 9   | Everything      | Dayyon Alexander / Quintin Gulledge / Ella Mai / Dijon McFarlane / Jeff Shum                                                                                     | Ella Mai feat. John Legend | 03:01 |
