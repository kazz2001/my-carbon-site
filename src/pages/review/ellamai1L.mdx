...
description: "CD review of Ella Mai / Ella Mai"
...
<h3><Link to="/best50/2018/">2018 Black Music Best No.25</Link></h3>

<Row  className="image-card-group">
	<Column colMd={"4"} colLg={"4"} noGutterMdLeft="">
       <ImageCard>

![ellamai1](../../images/cd/ellamai1L.jpg)
    ...
    <div>
	  <Button href="https://amzn.to/3ekoIWW" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
      </Button>
      <Button href="https://amzn.to/2zOkGqN" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
      </Button>
	</div>
