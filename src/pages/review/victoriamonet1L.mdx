...
![Victoria Monét / Jaguar](../../images/cd/victoriamonet1L.jpg) 
  ...
  <div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3sc2ptR" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/2LbKOSf" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
    <Button className="button-right-mergin"  href="https://apple.co/39kM2m3" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      apple music
    </Button>
	</div>
	</Column>
