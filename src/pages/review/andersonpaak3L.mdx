...
![Anderson.Paak / Oxnard](../../images/cd/andersonpaak3L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
    	...
    	<div>
		 		<Button className="button-right-mergin"  href="https://amzn.to/2B4MqYP" renderIcon={ArrowUpRight} size='sm' kind='primary'>
   	  		amazon.com
    	 	</Button>
	 			<Button className="button-right-mergin"  href="https://amzn.to/2YrfouF" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
     			amazon.co.jp
     		</Button>
				<Button className="button-right-mergin"  href="https://apple.co/3R1Ocxv" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      		apple music
    		</Button>
	 		<AdvJS2/>
	 		</div>
...
| 3   | Tints             | Brandon Anderson, Jeff Gitelma, Sydney Bennett, Robert Lewis, Kendrick Duckworth, David Pimentel, Taylor Parks, Om'Mas Keith            | Brandon Anderson .Paak feat. Kendrick Lamar                      | 04:28 |
