...
![Lil Baby / My Turn](../../images/cd/lilbaby1L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3dV104A" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3mDHz4j" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
    <Button className="button-right-mergin"  href="https://apple.co/3t7ZZfW" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      apple music
    </Button>
	</div>
	</Column>
