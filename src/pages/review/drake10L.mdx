...
import Review1 from "./drake11.mdx";
import Review2 from "./drake9.mdx";
import Review3 from "./drake8.mdx";
import Review4 from "./drake7.mdx";
...
![Drake / For All The Dogs](../../images/cd/drake10L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<p>
			Drakeの1年ぶり作品で、スタジオアルバムとしては8作目。前作はハウスだったが、当作では既定路線に戻り、23曲、84分という大作となっている。ただ、全体としてのコンセプトがあるわけではないので、すこしずつ聴くのも良いと思う。
				<br/>声が地味目で、フローもアンニュイで抑揚がない人だが、各曲ともそんな第一印象と違って、Trackはかなりポップ。盟友Noah "40" Shebibの出番は控えめで、様々なProducerを起用しており、Bad Bannyを迎えたラテン曲⑲などバラエティにも富んでいるし、聴きどころも多い。
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Kid Masterpiece(18)
				<br/>OZ, Nik D, Gordo(19)
				...
				<br/>Lil Yachty, Anthoine Walters, Beatmenace, 40, Gentuar Memishi and Bangs(23)
			</p>
			<h3>Guests</h3>
			<p>
