...
![Ariana Grande / Positions](../../images/cd/arianagrande6L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3vzIFB4" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3u8t7E8" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
		<Button className="button-right-mergin"  href="https://apple.co/2PDBF70" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      apple music
		</Button>
		</div>
	</Column>
