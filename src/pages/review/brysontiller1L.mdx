...
![Bryson Tiller / True To Self](../../images/cd/brysontiller1L.jpg)
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		...
		<div>
			...
			<Button className="button-right-mergin" href="https://apple.co/44UBer2" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
				apple music
			</Button>
			<AdvJS2/>
		</div>
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Hollywood Hot Sauce(6)
				<br/>J-Louis(7)
				<br/>Boi-1da(9)
				<br/>Ayo(12)
				<br/>Boi-1da, Illmind and Prologic(14)
