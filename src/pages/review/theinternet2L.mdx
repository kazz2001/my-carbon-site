...
<p className="largeP"><Link to="/best50/2024/">2018 Black Music Best No.28</Link></p>
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
  	  ...
  	  <Button className="button-right-mergin"  href="https://amzn.to/2YfteAj" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
  	    amazon.co.jp
			...
			<Button className="button-right-mergin"  href="https://apple.co/3UWr2Kj" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
  	    apple music
  	  </Button>
		</div>
	</Column>
