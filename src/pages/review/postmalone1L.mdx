...
![Post Malone / beerbongs & bentleys](../../images/cd/postmalone1L.jpg) 
    ...
    <div>
	    <Button href="https://amzn.to/2BC5ttL" kind="primary" size="small" renderIcon={ArrowUpRight24}>
        amazon.com
      </Button>
      <Button href="https://amzn.to/2ZDZyfE" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
        amazon.co.jp
       </Button>
	  </div>
