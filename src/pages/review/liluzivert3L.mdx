	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
	  <p>
	    Lil Uzi Vertの3年ぶり3作目。Vonus Track扱いの3曲を含む26曲87分弱の、前作を凌ぐ大作であり、そのうち18曲をBillboard Hot100に送り込んでいる。
			<br/>制作は前作同様、Brandon Finessinが中心となり、Bugz Roninあたりが存在感を示している。Trackはダークで音圧高め。今までの方向性は変わってないが、特に後半、ハード目のRockっぽい曲が続いたり、エレクトロな曲やホラーな感じの曲もあったりと様々。
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Bring Me The Horizon, Evil Twin and Zakk Cervini(18)
