...
![The Weeknd / Dawn FM](../../images/cd/weeknd7L.jpg)
	...
	<Column colMd={"4"} colLg={"8"} noGutterMdLeft="">
		<p>
			The Weekndの2年弱ぶりのアルバム。世相にマッチして好評だった前作の勢いを切らさずに、適度なインターバルでのリリースとなっている。タイトルにあるように架空のFM局"Fawn FM"による番組風になっていて、曲間をActorのJim Careyなどのナレーションによって、切れ目なく繋ぐ構成になっている。
		...
		<div>
		  <Button className="button-right-mergin"  href="https://amzn.to/3F30u1l" kind="primary" size="small" renderIcon={ArrowUpRight24}>
  	    amazon.com
  	  </Button>
  	  <Button className="button-right-mergin"  href="https://amzn.to/3MJY2jd" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
  	    amazon.co.jp
  	  </Button>
			<Button className="button-right-mergin"  href="https://apple.co/3KpvOst" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      	apple music
    	</Button>
			<AdvJS2/>
		</div>
