...
import Review2-1 from "../review/jpegmafia_dannybrown1.mdx";

<p className="largeP">Album Review</p>
<h1 className="h1--no--margin">{props.pageContext.frontmatter.title}</h1>
<p className="largeP">
  <Link to="/best50/2019/">2019 Black Music Album Best No.19</Link>
</p>
...
![JPEGMAFIA / All My Heros Are CornBalls](../../images/cd/jpegmafia1L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3cl5fU9" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3chPMnT" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
	</div>
