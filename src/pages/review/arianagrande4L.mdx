...
description: "Album Review of Ariana Grande / Sweetener"
...
<p className="largeP"><Link to="/best50/2018/">2018 Black Music Best No.5</Link></p>
...
![Ariana Grande / Sweetener](../../images/cd/arianagrande4L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/2YDjSxj" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
      </Button>
      <Button className="button-right-mergin"  href="https://amzn.to/30OsAvs" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
      </Button>
	</div>
