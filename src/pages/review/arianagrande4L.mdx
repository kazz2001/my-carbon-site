...
import Review3 from "../review/arianagrande5.mdx";
...
![Ariana Grande / Sweetener](../../images/cd/arianagrande4L.jpg)
  ...
  <Column colMd={4} colLg={8} noGutterMdLeft="">
    <p>
      ...
      <br/>前者の象徴、Max Martinは一曲のみで、代わりにPharrellが7曲をProduceし、軽妙なHip-Hop Soul、可憐なPop、流麗なバラードのバランスがうまい具合にとれたアルバムになっている。
    ...
    <div>
      ...
      <Button className="button-right-mergin" href="https://apple.co/4bOBydh" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
        apple music
      </Button>
      <AdvJS2/>
    </div>
...
| 5   | God is a woman             | Ariana Grande / Rickard Göransson / Savan Kotecha / Max Martin / Ilya Salmanzadeh  | Ariana Grande                         | 03:17 |
