...
![Leon Bridges / Gold-Diggers Sound](../../images/cd/leonbridges3L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		...
		<div>
			<Button className="button-right-mergin"  href="https://amzn.to/3EpG2G7" renderIcon={ArrowUpRight} size='sm' kind='primary'>
				amazon.com
			</Button>
			<Button className="button-right-mergin"  href="https://amzn.to/3H5MJ1G" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
				amazon.co.jp
			</Button>
			<Button className="button-right-mergin"  href="https://apple.co/3qo8IKF" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
				apple music
			</Button>
			<AdvJS2/>
		</div>
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Ricky Read, Nate Mercereau, 9 AM, Mike Blankenship and King Garbage(4)
