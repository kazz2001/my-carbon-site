...
import Review1_1  from "../review/runthejewels4.mdx"
...
![Run The Jewels / Run The Jewels 3](../../images/cd/runthejewels3L.jpg) 
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		...
		<div>
		  <Button className="button-right-mergin"  href="https://amzn.to/2OUfsxq" renderIcon={ArrowUpRight} size='sm' kind='primary'>
  	    amazon.com
  	  </Button>
  	  <Button className="button-right-mergin"  href="https://amzn.to/2D3fvEJ" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
  	    amazon.co.jp
  	  </Button>
		</div>
