...
![Gallant / Ology](../../images/cd/gallant1L.jpg)
    ...
    <Button className="button-right-mergin"  href="https://amzn.to/33RWj8b" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
		...
		<Button className="button-right-mergin"  href="https://apple.co/3wZK6z7" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
		<AdvJS2/>
	</div>
...
| 14  | Skipping Stones          | Jhené Aiko / Ajay Bhattacharyya / Christopher Gallant / Adrian Younge                    | Gallant feat. Jhené Aiko | 03:04 |
