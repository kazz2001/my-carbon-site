...
import Review2 from "../review/beyonce6.mdx";
...
![Beyoncé / Lemonede](../../images/cd/beyonce5L.jpg)
    ...
    <div>
      ...
      <Button className="button-right-mergin"  href="https://apple.co/3UU1E7Y" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
        apple music
      </Button>
      <AdvJS2/>
	  </div>
