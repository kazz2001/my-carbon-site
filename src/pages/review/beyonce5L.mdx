...
description: "Album Review of Beyoncé / Lemonade"
keywords: "Beyoncé, Lemonade, ビヨンセ, レモネード"
---
...
![Beyoncé / Lemonade](../../images/cd/beyonce5L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Diplo, Beyonce and Ezra Koenig(2)
				<br/>Jack White and Beyonce(3)
				<br/>Melo-X, Beyonce and Wynter Gordon(4)
				<br/>Donnboystyles, Ben Billions, Beyonce and Boots(5)
				<br/>Beyonce(6)
				<br/>Mike Dean #MWA and Beyonce(7)
				<br/>Beyonce and Vincent Berry II(8)
				<br/>James Blake and Beyonce(9)
				<br/>Jonny Coffer, Beyonce and Just Blaze(10)
				<br/>Diplo and Beyonce(11)
