...
![Moor Mother / Black Encyclopedia of The Air](../../images/cd/moormother1L.jpg)
	...
	<Column colMd={"4"} colLg={"8"} noGutterMdLeft="">
		<p>
  		...
  		<div>
			<Button className="button-right-mergin"  href="https://amzn.to/3F3ief6" kind="primary" size="small" renderIcon={ArrowUpRight24}>
  	  	amazon.com
  		</Button>
  		<Button className="button-right-mergin"  href="https://amzn.to/3TLNCDg" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
  	  	amazon.co.jp
  		</Button>
			<Button className="button-right-mergin"  href="https://apple.co/3MVmLlL" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
  	  		amazon.co.jp
  		</Button>
			<AdvJS2/>
		</div>
