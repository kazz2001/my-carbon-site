...
![Jyoti / Mama, You Can Bet!](../../images/cd/georgiaannemuldrow2L.jpg) 
	...
	<div>
	  <Button href="https://amzn.to/33a9sIq" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button href="https://amzn.to/35Qmz3j" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
    <Button href="https://apple.co/2KoBY2w" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      apple music
    </Button>
	</div>
	</Column>
