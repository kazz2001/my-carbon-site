...
import Review1_1 from "../review/billywoods2.mdx";
import Review1_2 from "../review/billywoodskennysegal1.mdx";
...
<p className="largeP">
	<Link to="/best50/2022/">2022 Black Music Best No.19</Link>
</p>
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Preservation and Glow in the Dark Flowers(6)
				<br/>Billy Woods and Preservation(9)
			</p>
			<h3>Guests</h3>
			<p>
