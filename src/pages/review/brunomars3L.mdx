...
import Review11 from "../review/brunomars4.mdx";
...
![Bruno Mars / 24K Magic](../../images/cd/brunomars3L.jpg)
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<p>
			...
			<br/>80年代後半から90年代前半の、いわゆるブラコンと呼ばれていたFunkでDiscoな音楽へのオマージュがたっぷりで、Zapp, Michael Jackson, New Jack Swing, JBなどを思わせる曲が散りばめられている。
		...
		<div>
			...
			<Button className="button-right-margin"  href="https://apple.co/4caqc3F" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
				apple music
			</Button>
			<AdvJS2 />
		</div>
