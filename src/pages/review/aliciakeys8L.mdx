...
![Alicia Keys / KEYS](../../images/cd/aliciakeys8L.jpg)
    ...
    <br/>OriginalsはAlicia中心のオーソドックスなTrackとなっており、UnlockedはMike Will Made-ItとAliciaによる、今風のサウンドのTrackになっていて、はっきりとした違いがあるので、聴き比べると、Producerの工夫やアイデアが明確になって面白い。
  ...
  <Column colMd={4} colLg={8} noGutterMdLeft="">
    <div>
      ...
      <p>
        ...
        <br/>Alicia Keys(2,3)
        <br/>Fred Ball and Alicia Keys(4)
        <br/>arrabMUSIK(6)
