...
import Review1_1 from "../review/billywoods1.mdx";
import Review1_2 from "../review/billywoods2.mdx";

import Review2_1  from "../review/armandhammer1.mdx";
...
![Billy Woods and Kenny Segal / Maps](../../images/cd/billywoodskennysegal1L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<p>
			...
			<br/>Billy Woodsの作品にしては、だいぶ、聴き易く、Criticの評価も高い。Song WritingはBilly Woods、ProduceはKenny Segalという役割分担となっている。また、Guestでは、Armand Hammerのもう一人、ELUCIDやAesop Rockなどが参加している。
		...
		<div>
			...
			<Button className="button-right-mergin"  href="https://amzn.to/4qMBHoQ" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
				amazon.co.jp
			</Button>
