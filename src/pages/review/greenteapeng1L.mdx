...
<<<<<<< HEAD
	<p>
		...
		<br/>ゆったりとして揺らいだような曲が多く、5人編成のバンドによるTrackはよくよく聞くとジャズ、レゲエ、インド音楽、エレクトロなどのジャンルをまたがった多彩なもの。これにGreentea Pengの抑えたVocalが加わり、中毒性を強めている。
	</p>
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/2Wsmpxm" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3oj2xs2" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
		<Button className="button-right-mergin"  href="https://geo.music.apple.com/us/album/man-made/1561826242?itsct=music_box_link&itscg=30200&at=11lcug&ls=1&app=music" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
		<AdvJS2/>
	</div>
...
| 12  | Dingaling              | Aria Wells, Anish Bhatt, Tagara Mhiza, Jordan Thompson Hadfield, Tony Olabode, Ryan Benton Thomas, Armedu Augusutine, Idibia Innocent Ujah                         | Greentea Peng                         | 03:20 |
