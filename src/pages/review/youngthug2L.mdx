...
description: CD review of Young THug / Jeffery
...
![Young THug / Jeffery](../../images/cd/youngthug2L.jpg) 
	...
	<div>
	  <Button href="https://amzn.to/31V9HFV" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
	  <Button href="https://amzn.to/2PTSCXx" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
	</div>
	...
	<a href="https://geo.music.apple.com/jp/album/jeffery/1146718343?app=itunes&at=11lcug" style="display:inline-block;overflow:hidden;background:url(https://linkmaker.itunes.apple.com/ja-jp/badge-lrg.svg?releaseDate=2016-08-26T00:00:00Z&kind=album&bubble=itunes_music) no-repeat;width:140px;height:45px;"></a>
	</Column>
</Row>
<Row >
	<Column colMd={"4"} colLg={"4"} noGutterMdLeft="">
