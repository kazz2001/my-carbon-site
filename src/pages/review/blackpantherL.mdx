...
description: "CD review of Black Panther The Album"
...
<p className="largeP"><Link to="/best50/2018/">2018 Black Music Best No.13</Link></p>
...
![Black Panther The Album](../../images/cd/blackpantherL.jpg) 
	...
	<div>
	  <Button href="https://amzn.to/2NyE5PK" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
      </Button>
      <Button href="https://amzn.to/2ZaLM3X" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
      </Button>
	</div>
	...
	<a style="display:inline-block;overflow:hidden;background:url(https://linkmaker.itunes.apple.com/ja-jp/badge-lrg.svg?releaseDate=2018-02-09T00:00:00Z&kind=album&bubble=itunes_music) no-repeat;width:140px;height:45px;" href="https://geo.music.apple.com/jp/album/black-panther-the-album-music-from-and-inspired-by/1440906927?app=itunes&at=11lcug"></a>
	</Column>
</Row>
<Row >
	<Column colMd={"4"} colLg={"4"} noGutterMdLeft="">
...
<h3>Guests</h3>
<p>
KKendrick Lamar, SZA, 2 Chainz, ScHoolboy Q, Saudi, Khalid, Swae Lee, Yugen Blakrok, Vince Staples, Jorja Smith, SOB X RBE, Anderson .Paak, Ab-Soul, James Blake, Future, Jay Rock, Zacari, Babes Wodumo, Mozzy, Reason, Sjava, Travis Scott, The Weeknd
</p>
</div>
</Column>
</Row>
