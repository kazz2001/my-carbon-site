...
description: Album Review of Danny Brown / Atrocity Exhibition 
...
![Danny Brown / Atrocity Exhibition ](../../images/cd/dannybrown3L.jpg) 
	...
	<Column colMd={"4"} colLg={"8"} noGutterMdLeft="">
		...
		<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/35bGbik" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3jUbYZc" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
		</div>
