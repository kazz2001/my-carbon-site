...
<p className="largeP">
  <Link to="/best50/2023/">2023 Black Music Best No.15</Link>
</p>
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Rodney "Darkchild" Jerkins and Marvin "ToneWorld" Hemmings(9)
				<br/>Dylan Wiggins and Kali Uchis(10)
				<br/>Clairmont The Second(11)
				<br/>Josh Crocker, Kali Uchis and Yussef Dayes(12)
