...
![Brockhampton / Roadrunner: New Light, New Machine](../../images/cd/brockhampton2L.jpg)
    ...
    <Button className="button-right-mergin"  href="https://amzn.to/2ZfVENr" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
		...
		<Button className="button-right-mergin"  href="https://geo.music.apple.com/us/album/roadrunner-new-light-new-machine-plus-pack/1569675412?itsct=music_box_link&itscg=30200&at=11lcug&ls=1&app=music" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      ampple music
    </Button>
		<AdvJS2/>
	</div>
