...
import Review1 from "../review/drake11.mdx";
import Review2 from "../review/drake10.mdx";
...
![Drake / Certified Lover Boy](../../images/cd/drake8L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<p>
			...
			<br/>とはいえ、個々の曲のクオリティは決して悪くないし、かえってバラエティに富んでいて、最後まで惰性に陥ることはないのは流石。
		...
		<div>
			<Button className="button-right-mergin" href="https://amzn.to/3A4p53H" renderIcon={ArrowUpRight} size='sm' kind='primary'>
				amazon.com
			</Button>
			<Button className="button-right-mergin" href="https://amzn.to/339tF4k" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
				amazon.co.jp
			</Button>
			<Button className="button-right-mergin" href="https://apple.co/3tkU3Ty" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
				apple music
			</Button>
			<AdvJS2/>
		</div>
	...
	<Column colMd={8} colLg={8} noGutterMdLeft="">
		<div>
			...
			<p>
				...
				<br/>Leon Thomas III, FAXONLY, Jean Bleu, Simon Gebrelul and Anthoine Walters(10)
