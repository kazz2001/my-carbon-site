...
![Spillage Village / Spilligion](../../images/cd/spillagevillage1L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3aeYhky" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3aeYwMu" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
    <Button className="button-right-mergin"  href="https://apple.co/3clDMFA" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      apple music
    </Button>
	</div>
	</Column>
