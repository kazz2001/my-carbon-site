...
![Tyler, The Creator / Call Me If You Get Lost](../../images/cd/tyler5L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3lGwf8M" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3s0XTif" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
		<Button className="button-right-mergin"  href="https://geo.music.apple.com/us/album/call-me-if-you-get-lost/1573484415?itsct=music_box_link&itscg=30200&at=11lcug&ct=albums_call_me_if_you_get_lost&ls=1&app=music" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
      apple music
    </Button>
		<AdvJS2/>
	</div>
