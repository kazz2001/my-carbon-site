...
keywords: "Blood Orange, Freetown Sound, ブラッド・オレンジ, フリータウン・サウンド"
---
...
![Blood Orange / Freetown Sound](../../images/cd/bloodorange2L.jpg)
    ...
    <Column colMd={4} colLg={8} noGutterMdLeft="">
    	...
    	<div>
    		...
    		<Button className="button-right-mergin"  href="https://apple.co/3KlofoM" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
    			apple music
    		</Button>
    		<AdvJS2/>
    	</div>
...
| 4   | Best to You     | Devonte Hynes, Lorely Rodriguez, Christopher Amoo and Edward Amoo | Blood Orange | 03:45 |
| 5   | With Him        | Devonte Hynes and Beatriz De Rijke                                | Blood Orange | 01:25 |
| 6   | E.V.P           | Devonte Hynes, Beatriz De Rijke and Waliou Jacques Badarou        | Blood Orange | 05:43 |
