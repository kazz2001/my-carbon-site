...
description: "Album Review of Blood Orange / Freetown Sound"
...
![Blood Orange / Freetown Sound](../../images/cd/bloodorange2L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/337m82a" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/328ZSWf" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
	</div>
