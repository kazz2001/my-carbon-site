...
import Review2 from "../review/dave3.mdx";
...
![Dave / We're All Alone In This Together](../../images/cd/dave2L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		...
		<div>
			<Button className="button-right-mergin" href="https://amzn.to/3sLQ8yu" renderIcon={ArrowUpRight} size='sm' kind='primary'>
				amazon.com
			</Button>
			<Button className="button-right-mergin" href="https://amzn.to/3KmfVmY" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
				amazon.co.jp
			</Button>
			<Button className="button-right-mergin" href="https://apple.co/3tzCQUR" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
				apple music
			</Button>
			<AdvJS2/>
		</div>
