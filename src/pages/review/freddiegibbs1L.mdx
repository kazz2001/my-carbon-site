...
import Review1 from "../review/fgibbsalchemist2";
import Review2 from "../review/fgibbsalchemist1";
import Review3 from "../review/fgibsandmadlib2";

<p className="largeP">Album Review</p>
<h1 className="h1--no--margin">{props.pageContext.frontmatter.title}</h1>
<p className="largeP">
  <Link to="/best50/2022/">2022 Black Music Best No.37</Link>
</p>
...
![Freddie Gibbs / $oul $old $eparately](../../images/cd/freddiegibbs1L.jpg)
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
		<p>
			...
			<br/>これに⑩のようなメロウなTrackや⑮のようなMusiq Soulchild参加の抒情的な曲が加わっている。
...
| 5   | Too Much             | IV Beatss / Norva Denton / Ben Lambert / Fredrick Tipton / Demario White  | Freddie Gibbs feat. Moneybagg Yo            | 03:32 |
