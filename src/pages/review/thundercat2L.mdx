...
description: CD review of Thundercat / It Is What It Is
...
![Thundercat / It Is What It Is](../../images/cd/thundercat2L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/3fLBKg8" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3ip7EAL" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
	</div>
