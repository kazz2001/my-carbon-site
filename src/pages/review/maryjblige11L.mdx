...
![Mary J. Blige / Good Morning Gorgeous](../../images/cd/maryjblige11L.jpg)
	...
	<Column colMd={"4"} colLg={"8"} noGutterMdLeft="">
  	...
  	<div>
		  <Button className="button-right-mergin"  href="https://amzn.to/3BY0BMd" kind="primary" size="small" renderIcon={ArrowUpRight24}>
  	    	amazon.com
  	  </Button>
  	  <Button className="button-right-mergin"  href="https://amzn.to/3PgDKhO" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
  	   	amazon.co.jp
  	  </Button>
			<Button className="button-right-mergin"  href="https://apple.co/3SFcWej" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
  	    amazon.co.jp
  	  </Button>
			<AdvJS2/>
		</div>
