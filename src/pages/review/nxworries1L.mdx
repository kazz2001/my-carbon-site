...
import Review1_1 from "../review/nxworries2.mdx";
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
  	  ...
  	  <Button className="button-right-mergin"  href="https://amzn.to/2EMdsFY" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
  	    amazon.co.jp
			...
			<Button className="button-right-mergin"  href="https://apple.co/3R17mDQ" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
				apple music
			</Button>
			<AdvJS2/>
		</div>
