...
![SZA / Ctrl](../../images/cd/sza1L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/2DGfW8e" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3h0IvvA" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
	</div>
