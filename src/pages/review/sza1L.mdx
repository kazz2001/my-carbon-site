---
title: SZA / Ctrl
description: Album review of SZA / Ctrl
keywords: 'SZA, Ctrl'
---
...
![SZA / Ctrl](../../images/cd/sza1L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/2DGfW8e" renderIcon={ArrowUpRight} size='sm' kind='primary'>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3h0IvvA" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
      amazon.co.jp
    </Button>
	</div>
