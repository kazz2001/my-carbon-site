...
![Terrace Martin, Robert Glasper, 9th Wonder, Kamasi Washington / Dinner Party: Dessert](../../images/cd/martinglasperwonderwashington1L.jpg)
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/39PDJjS" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/37FT1VY" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
		<Button className="button-right-mergin"  href="https://apple.co/2VLWYTh" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      apple music
    </Button>
		<AdvJS2/>
	</div>
