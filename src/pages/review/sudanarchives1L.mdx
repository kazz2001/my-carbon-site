...
import Review2 from "../review/sudanarchives2.mdx";
	...
	<Column colMd={4} colLg={8} noGutterMdLeft="">
  	  ...
  	  <Button className="button-right-mergin"  href="https://amzn.to/32xz6r3" renderIcon={ArrowUpRight} size='sm' kind='secondary'>
  	    amazon.co.jp
			...
			<Button className="button-right-mergin"  href="https://apple.co/4azn53J" renderIcon={ArrowUpRight} size='sm' kind='tertiary'>
  	    apple music
  	  </Button>
			<AdvJS2/>
		</div>
