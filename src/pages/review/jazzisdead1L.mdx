...
description: "CD review of Adrian Younge & Ali Shaheed Muhammad / Jazz Is Dead 001"
...
![Adrian Younge & Ali Shaheed Muhammad / Jazz Is Dead 001](../../images/cd/jazzisdead1L.jpg) 
  ...
  <div>
	  <Button href="https://amzn.to/31gxl0e" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button href="https://amzn.to/3o044QS" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
    <Button href="https://apple.co/3jZXg3s" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      apple music
    </Button>
	</div>
  </Column>
