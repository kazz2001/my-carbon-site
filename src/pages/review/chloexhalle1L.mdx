...
<p className="largeP"><Link to="/best50/2020/">2020 Black Music Best No.3</Link></p>
...
![Chloe x Halle / Ungodly Hour](../../images/cd/chloexhalle1L.jpg) 
	...
	<div>
	  <Button className="button-right-mergin"  href="https://amzn.to/37ErDsX" kind="primary" size="small" renderIcon={ArrowUpRight24}>
      amazon.com
    </Button>
    <Button className="button-right-mergin"  href="https://amzn.to/3jrEtx4" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
      amazon.co.jp
    </Button>
		<Button className="button-right-mergin"  href="https://apple.co/34tJDo1" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
      apple music
    </Button>
	</div>
	</Column>
