...
const FirstRightText = () => (
    <div>
        ...
        <Button href="/best50/2018/" kind="tertiary" size="small" renderIcon={ArrowUpRight24}>
          2018
        </Button>
        <Button href="/best50/2017/" kind="primary" size="small" renderIcon={ArrowUpRight24}>
          2017
        </Button>
        <Button href="/best50/2016/" kind="secondary" size="small" renderIcon={ArrowUpRight24}>
          2016
        </Button>
	    </div>
